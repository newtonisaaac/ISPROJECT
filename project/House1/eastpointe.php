...
<body>
	...
	<h2 style="font-family: Times New Roman; text-align: left; color: black; padding-left: 18px"></h2>
	<p style="padding-left: 18px">
		2 & 3 Bedroom Apartments<br/>
		From Kshs 6.95M<br/>
		monthly rent of 50,000<br/>
	</p>
	<div>
	...
	<h2 style="font-family: Helvetica; text-align: left; color: #f0932b; padding-left: 18px">Residences</h2>
		...
		<h2 style="font-family: Helvetica; text-align: left; color: #f0932b; padding-left: 18px">Amenities & Provisions</h2>
			...
			<p style="text-align: left; padding-left: 18px; padding-right: 18px;">
				...
				They have amenities including swimming pools and a garden, an ultra madern gym and stream bath that give off a lush lifestyle. other amenities and provision offered are:
				<ul>
	...
	<footer style="background-color: #1e272e">
		<section class="box">
			<div class="boxes" style="color: #ffffff;">
				<h3 style="color: #7f8c8d">RHUMBA</h3><br/><br/>
				P.O Box 23231- 10100
				NYALI, MOMBASA,<br/>
				Nairobi, Kenya.<br/><br/>
